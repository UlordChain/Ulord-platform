...
_METADATA_TAG = _descriptor.EnumDescriptor(
  name='Tag',
  full_name='Metadata.Tag',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_METADATA_TAG)
...
_METADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tag', full_name='Metadata.tag', index=11,
...
_METADATA.fields_by_name['tag'].enum_type = _METADATA_TAG
_METADATA_VERSION.containing_type = _METADATA
_METADATA_LANGUAGE.containing_type = _METADATA
_METADATA_TAG.containing_type = _METADATA
